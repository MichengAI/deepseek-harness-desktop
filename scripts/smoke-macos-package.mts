...
export function resolveMacApplicationExecutable(applicationBundle: string): string {
  const applicationName = basename(applicationBundle, '.app')
  return join(applicationBundle, 'Contents', 'MacOS', applicationName)
}
